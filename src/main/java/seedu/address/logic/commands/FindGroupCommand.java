...
public class FindGroupCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all persons whose groups contain any of "
            ...
            + "Example: " + COMMAND_WORD + " group1 group2 group3";

    private final GroupContainsKeywordsPredicate predicate;

    /**
     * Creates a FindGroupCommand to find the specified {@code GroupContainsKeywordsPredicate}
     * @param predicate the predicate to find the group (case-insensitive)
     */
    ...
    /**
     * Executes the FindGroupCommand to find the specified {@code GroupContainsKeywordsPredicate}
